 ...
 * @description:
 * @author: yangsaixing
 * @date: Created in 2021/5/21 下午3:03
 * @modified By:
 */
    ...
    public class Test {
        ...
        private static String content="仅在小希教育平台使用，复印无效";

        private static Color RED=Color.GRAY;

        static String outPath="/Users/daitiantian/Desktop/test.jpeg";
        ...
        public static void main(String[] args) {
            ...
            new Test().wordMarkForImg(srcPath,outPath);
      ...
      /*  BufferedImage bufferedImage=new BufferedImage(500,300,BufferedImage.TYPE_INT_RGB);
        ...
        public BufferedImage wordMarkForImg2(InputStream inputStream){
        ...
        private void setMarkLocation(int srcImgWidth, int srcImgHeight, Graphics2D graphics) {
            ...
            while(x<srcImgWidth*10){
                ...
                while (y < srcImgHeight * 10) {
                    graphics.setFont(new Font("宋体", Font.PLAIN, 50));
